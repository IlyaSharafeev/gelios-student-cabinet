        ...
        <div class="homework-details">
          <div class="homework-grid">
            ...
            <div class="homework-rewards">
              ...
              <span class="reward-value"><span class="gelios-coin">
...
.homework-item.completed {
  background: #D7FFD0;
  background-image: url("@/assets/backgrounds/background-reward.png");
  padding: 10px 15px;
}
